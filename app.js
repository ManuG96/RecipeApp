...
function addMealToFav(meal){
    ...
    x.addEventListener("click", () => {
        ...
        heart_btns.forEach(heart_btns => heart_btns.setAttribute("class", "fa-regular fa-heart"))
        fetchFavMeals();
    });
...
search_icon.addEventListener("click", async () => {
    ...
    if(meals){
        ...
        document.querySelector(".meals-container > h2").innerHTML = "Search Results...";
    } else{
        document.querySelector(".meals-container > h2").innerHTML = "No Meals Found...";
        mealEl_container.innerHTML = "";
    }
});
